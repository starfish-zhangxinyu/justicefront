<template>
  <el-container>
    ...
    <el-container id="container_right">
      <header style="height: 53px" class="header">
            <Header></Header>
        </header>
      <div class="main">
        <div>
          <p>f</p><p>f</p><p>f</p><p>f</p><p>f</p><p>f</p><p>f</p><p>f</p><p>f</p><p>f</p><p>f</p><p>f</p><p>f</p><p>f</p><p>f</p><p>f</p><p>f</p><p>f</p><p>f</p><p>f</p><p>f</p><p>f</p><p>f</p><p>f</p><p>f</p><p>f</p>
        </div>
          <!-- <router-view name="childRoute" class="main_box" :key="$route.fullPath"/> -->
      </div>
