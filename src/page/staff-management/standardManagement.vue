        ...
        <el-tabs type="border-card" v-model="activeName" @tab-click="handleClick">
            <el-tab-pane label="标准列表" name="list">
                ...
                <el-table :data="tableData" stripe border size="mini" fit style="width: 100%">
                    <el-table-column prop="name" label="标准号"></el-table-column>
                    <el-table-column prop="birthday" label="标准名称">
                        <template slot-scope="scope">
                            <span v-if="scope.row.birthday">{{divideDate(scope.row.birthday)}}</span>
                        </template>
                    </el-table-column>
                    <el-table-column prop="educationBackground.label" label="标准类别"></el-table-column>
                    <el-table-column prop="professionalTitle.label" label="专业类别"></el-table-column>
                    <el-table-column prop="office.name" label="标准发布日期"></el-table-column>
                    <el-table-column prop="office.name" label="标准实施日期"></el-table-column>
                    <el-table-column prop="office.name" label="机构实施日期"></el-table-column>
                    <el-table-column prop="office.name" label="机构作废日期"></el-table-column>
                    <el-table-column prop="office.name" label="标准状态"></el-table-column>
            ...
            <el-tab-pane :label="'标准添加/编辑'" :name="isAdd?'addlist':'changelist'">
                <el-row>
                    <el-col :span="16">
                        <div class="portlet">
                            ...
                            <div class="portlet-body" style="padding: 8px 8px 8px 8px">
                                <el-form :model="addForm" size="small" ref="staffForm" label-width="150px">
                                    <el-row>
                                        <el-col :lg="{span:16}">
                                            <el-form-item label="标准名称" prop="name" :rules="$filter_rules({required:true})">
                                    ...
                                    <el-row>
                                        <el-col :lg="{span:16}">
                                            <el-form-item label="标准号" prop="name" :rules="$filter_rules({required:true})">
                                                <el-input v-model.trim="addForm.name"></el-input>
                                            </el-form-item>
                                        </el-col>
                                    </el-row>
                                    <el-row>
                                        <el-col :lg="{span:16}">
                                            <el-form-item label="标准组织类别" prop="sex"
                                    ...
                                    <el-row>
                                        <el-col :lg="{span:16}">
                                            <el-form-item label="专业类别" prop="sex"
                                                          :rules="$filter_rules({required: true, trigger: 'change'})">
                                                <el-select class="w100" v-model="addForm.sex" placeholder="请选择">
                                                    <el-option label="男" value="F"></el-option>
                                                    <el-option label="女" value="M"></el-option>
                                    ...
                                    <el-row>
                                        <el-col :lg="{span:16}">
                                            <el-form-item label="标准发布日期" prop="birthday">
                                                <el-date-picker
                                                        class="w100"
                                    ...
                                    <el-row>
                                        <el-col :lg="{span:16}">
                                            <el-form-item label="标准实施日期" prop="birthday" :rules="$filter_rules({required: true})">
                                                <el-date-picker
                                                        class="w100"
                                                        v-model="addForm.birthday"
                                                        type="date"
                                    ...
                                    <el-row>
                                        <el-col :lg="{span:16}">
                                            <el-form-item label="标准作废日期" prop="birthday">
                                                <el-date-picker
                                                        class="w100"
                                                        v-model="addForm.birthday"
                                                        type="date"
                                    ...
                                    <el-row>
                                        <el-col :lg="{span:16}">
                                            <el-form-item label="机构实施日期" prop="birthday">
                                                <el-date-picker
                                                        class="w100"
                                                        v-model="addForm.birthday"
                                                        type="date"
                                    ...
                                    <el-row>
                                        <el-col :lg="{span:16}">
                                            <el-form-item label="标准状态" prop="sex"
                                    ...
                                    <el-row>
                                        <el-col :lg="{span:16}">
                                            <el-form-item label="标准文本附件" prop="sex"
                                                          >
                                                    <el-upload class="w100" v-model="addForm.sex" placeholder="请选择">
                                                        <button>选择文件</button>
                                                    </el-upload>
...
<script>
    ...
    export default {
        ...
        created(){
            ...
            this.$store.dispatch("login/headerTitleChange", "标准管理")
        },
        beforeDestroy(){
