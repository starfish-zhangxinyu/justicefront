<template>
  <el-container>
    ...
    <el-container>
      <el-header style="height: 53px" class="header"></el-header>
      <el-main class="main" id="container_right">
...
export default {
  ...
  methods: {
    ...
    hasPermission: function(arr) {
      // console.log(arr,11111,this.$store.state.moduleLogin);
      for (let i = 0; i < arr.length; i++) {
