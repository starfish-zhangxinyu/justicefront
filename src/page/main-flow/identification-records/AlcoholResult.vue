<template>
    <el-form ref="form" label-width="130px" size="small" :model="alcoholResultForm" class="demo-ruleForm"  v-if="this.alcoholTestRecord">
        <Portlet title="酒精检测记录" v-if="alcoholType == '1'">
        ...
        <el-table-column
        label="RD">
        <template slot-scope="scope" prop="relativeDifference">
        <span>{{getRD1()}}</span>
        </template>
        </el-table-column>
        </el-table>
...
<script>
    ...
    export default {
        ...
        props: ['model', 'caseId', 'basicData','alcoholTestRecord','caseNoFlag'],
        data() {
            return {
                authRecordsMsg: null,
                path: 'ONE_PATH',
                spanArr: [],
                pos: '',
                computedTable: [{vy: '0.01x+0.03', vb: '0.01', va: '0.03', vr: '0.99', uncertainty: '4.4%',content:'',}],
...
//酒精
                ...
                for (var i = 0; i < data.length; i++) {
                    if (i === 0) {
                        ...
                        if(data[i].id) {
                            ...
                            if (data[i].sample.id === data[i - 1].sample.id) {
                                this.spanArr[this.pos] += 1;
                                this.spanArr.push(0);
                            } else {
                                this.spanArr.push(1);
            ...
            getContent(a, b, index) {
                ...
                /*if (!isNaN(Number(compareVal))) {
                    var value = this.toFixed((Number(compareVal) * m - Number(va) * m) / (Number(vb) * m), 2)
            ...
            getAverageContent() {
                ...
                if (this.alcoholResultForm.tertiaryButanolTable[0].content ) {
                    ...
                    this.tertiaryButanolAverageContent = null;
                    a = 0;
                    return;
                }
            ...
            getRD1() {
                ...
                if (this.alcoholResultForm.tertiaryButanolTable[0].content) {
                    ...
                    a = 0;
                    this.$set(this.computedTable[0],'relativeDifference',null);
                    return;
                }
                if (this.alcoholResultForm.tertiaryButanolTable[1].content) {
                    b = this.alcoholResultForm.tertiaryButanolTable[1].content.toString();
            ...
            init(basicData) {
                if (basicData) {
                    var arr = [].concat(basicData.authAlcoholResultList);
                    this.alcoholType = basicData.inputContentFlag;
                    ...
                    if(basicData.inputContentFlag === '0' && basicData.authAlcoholResultList && basicData.authAlcoholResultList.length > 0) {
                        if(this.caseNoFlag && (basicData.authAlcoholResultList[0].tertiaryButanol1 === null || basicData.authAlcoholResultList[0].va === null)) {
                            this.$get(api.alcoholParam,{caseNoFlag: this.caseNoFlag}).then(res => {
                            ...
                            this.computedTable = JSON.parse(JSON.stringify(basicData.authAlcoholResultList));
                            this.$emit('getComputedTable', this.computedTable);
                        }
                    }
            ...
            path: {
                handler(newVal, oldVal) {
                    if (newVal == 'TWO_PATH') {
                       ...
                       /* this.alcoholResultForm.doubleResultList.forEach((v, i) => {
                            v.time = '第一次测试值（mg/100ml）';
                            ...
                            v.content3 = null;
                            v.content4 = null;
                            this.alcoholResultForm.doubleResultList.splice(2 * i + 1, 0, data); 
                        }); */
                        ...
                        /* this.alcoholResultForm.singleResultList[0].content1 = null;
                        this.alcoholResultForm.singleResultList[0].content2 = null
                        this.alcoholResultForm.singleResultList[0].content3 = null
                        this.alcoholResultForm.singleResultList[0].content4 = null */
                        /* this.alcoholResultForm.doubleResultList[0].content1 = null
                        this.alcoholResultForm.doubleResultList[0].content2 = null
                        this.alcoholResultForm.doubleResultList[1].content1 = null
                        this.alcoholResultForm.doubleResultList[1].content2 = null */ 
