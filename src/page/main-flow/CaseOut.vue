<template>
    <div>
        <PageBar title1="业务流程" title2="出案"></PageBar>
        ...
        <el-form :model="caseOutForm" ref="caseOutForm" label-width="130px" size="small">
            ...
            <el-row style="margin-top: 50px">
                <el-col :span="2" :offset="11">
                    <el-button type="success" size="mini" class="save-btn" @click="save('caseOutForm')"><i
                            class="fa fa-save"></i> 保存
                    </el-button>
                </el-col>
                <el-col :span="2">
                    <el-button type="primary" size="mini" class="save-btn" @click="complate('caseOutForm')"><i
