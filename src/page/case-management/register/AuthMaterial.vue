    ...
    >
      ...
      <Portlet title="鉴定材料">
        ...
        <template slot="body">
          ...
          <!-- <el-table-column prop="type" label="鉴定材料类型" width="200%">
            ...
            <el-table-column width="300%" prop="name" label="送检鉴定材料">
              <template slot-scope="scope">
                <el-form-item
                  label-width="0px"
                  :prop="
      ...
      >
        ...
        <template slot="body">
          <el-table
            ...
            style="width: 100%"
          >
            <el-table-column prop="name" width="200%" label="补充材料名称">
              <template slot-scope="scope">
                <el-form-item
                  label-width="0px"
                  :prop="
      ...
      <el-dialog title="导入鉴定材料" :visible.sync="importMaterialDialog">
        ...
        >
          ...
          <el-table-column prop="materialType.label" label="类型">
          </el-table-column>
          <el-table-column prop="materialUnit.label" label="规格">
          </el-table-column>
          <el-table-column prop="handleType.label" label="处理方式">
          </el-table-column>
