<template>
    <div>
        <el-form ref="form" label-width="130px" size="small" :model="dnaResultForm" class="demo-ruleForm"
                 label-position="right" v-if="this.dnaTestResult">
                ...
                <el-row style="margin-top: 10px;line-height:20px;" v-if="codisForm.entrustingMatterKey!='NOCALCULATE'">
                    <el-col :span="6" style="margin-top:5px;">
                        <div style="width:100%;" >
                            ...
                            <span style="color:red;height:30px;line-height:30px;float:left" :style="{marginTop:codisForm.totalCalcResultSting && codisForm.totalCalcResultSting.includes('sup') ? '-5px':'0'}" v-html="$replaceSupTag(codisForm.totalCalcResultSting)">
                            </span>
                        </div>
                    </el-col>
                    <el-col :span="6" style="margin-top: 5px">
