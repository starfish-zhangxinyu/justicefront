<template>
    ...
    <el-form ref="form" label-width="130px" size="small" :model="alcoholResultForm" class="demo-ruleForm" v-if="this.alcoholTestRecord">
        ...
        <el-table-column
        label="乙醇/叔丁醇">
        <template slot-scope="scope" prop="vx">
...
<script>
    ...
    export default {
        ...
        props: ['model', 'caseId', 'basicData','alcoholTestRecord'],
        data() {
            return {
                authRecordsMsg: null,
                path: 'ONE_PATH',
                spanArr: [],
                pos: '',
                computedTable: [{vy: '0.01x+0.03', vb: '0.01', va: '0.03', vr: '0.99', uncertainty: '4.4%'}],
