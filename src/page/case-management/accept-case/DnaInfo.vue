<!--
 * @Description: <page>法医物证样本信息</page>页面
-->
  ...
  >
      ...
      <template slot="body">
        ...
        >
         <!--  <el-table-column prop="type" label="鉴定材料类型" width="200%">
            ...
            <template slot-scope="scope">
              ...
              >
                <el-input
                  ...
                  :disabled="scope.row.dnasampleDisabled || scope.row.isExport"
                ></el-input>
              </el-form-item>
            </template>
          </el-table-column>
          ...
          <el-table-column prop="credentialType" width="110px" label="证件类型">
            <template slot-scope="scope">
              <el-form-item
                label-width="0px"
          ...
          >
            <template slot-scope="scope">
              ...
              ></Uploadpictures>
              <!-- <el-button type="primary" icon="el-icon-camera-solid" size="mini" :disabled="scope.row.dnasampleDisabled||scope.row.isExport"></el-button> -->
              <!-- <Czur :multiple="true"></Czur> -->
              <Czur :model.sync="scope.row.images" class="czur"></Czur>
              <el-button
                type="danger"
                icon="el-icon-delete"
                size="mini"
                @click="deleteRow(scope.$index, scope.row)"
                :disabled="scope.row.dnasampleDisabled"
              ></el-button>
            </template>
          </el-table-column>
        </el-table>
    ...
    >
      ...
      >
        ...
        <el-table-column width="240px" prop="caseNos" label="案件编号">
        </el-table-column>
      </el-table>
...
export default {
  ...
  methods: {
    ...
    retriveBirthDay(index) {
      ...
      if (row.credentialType.label == "身份证") {
        ...
        this.birthDateChange(index, row.birthDate);
      }
    },
    //增加物证样本
    addDNASample() {
  ...
  created() {
    ...
    if (status == "CASE_SUPPLEMENT") {
      this.title = "案件编辑";
      this.dnasampleDisabled = true;
    }
    this.sex = null;
  },
  computed: {
